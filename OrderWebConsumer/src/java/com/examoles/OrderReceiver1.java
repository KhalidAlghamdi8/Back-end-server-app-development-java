...
public class OrderReceiver1 implements MessageListener {
    
    private final Logger logger = Logger.getLogger(OrderReceiver1.class);
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderReceiver1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
